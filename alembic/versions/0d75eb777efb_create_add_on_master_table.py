...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('is_percentage', sa.Boolean(), server_default=sa.false(), nullable=False),
        sa.Column('applies_to_product', sa.Boolean(), server_default=sa.true(), nullable=False),
